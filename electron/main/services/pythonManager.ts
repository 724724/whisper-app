...
function getBackendDir(): string {
  ...
  return join(app.getAppPath(), 'back')
}
...
export async function startBackend(): Promise<void> {
  ...
  // - In dev mode: always kill and restart so code changes are picked up
  // - In production: reuse the healthy server to avoid unnecessary restarts
