...
export default function App() {
  ...
  const mode: 'dark' | 'light' = theme === 'system' ? (systemDark ? 'dark' : 'light') : theme
  ...
  const muiTheme = useMemo(() => {
    ...
    return createTheme({
      ...
      typography: {
        fontFamily:
          '"Pretendard", -apple-system, BlinkMacSystemFont, "SF Pro Display", "Segoe UI", sans-serif',
        ...
        MuiCssBaseline: {
          styleOverrides: {
            'html, body, #root': {
              ...
              fontFamily:
                '"Pretendard", -apple-system, BlinkMacSystemFont, "SF Pro Display", sans-serif'
            }
          }
        },
        MuiPaper: {
          ...
          styleOverrides: {
            paper: {
              ...
              boxShadow: isDark
                ...
                : '0 20px 60px rgba(80,100,180,0.18)',
              borderRadius: '24px'
            }
          }
        },
